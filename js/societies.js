...
for(var x=0;x<images.length;x++)
    {
        ...
        col.classList.add('col','l4','m3','s1');
        society.push(new Society(images[x],images[x],desc));
        
        cardDiv = '<div class="card"><div class="card-image"><img src="http://ksac.kiit.ac.in/pix/societies/'+society[x].img+'"><span class="card-title white-text" style="font-size:50px;">'+society[x].img+'</span></div><div class="card-content"><p>'+society[x].desc+'</p></div><div class="card-action"><a href="#">Facebook page link</a><a href="society.html">Details link</a></div></div>';
